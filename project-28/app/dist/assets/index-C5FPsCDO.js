...
var Dr = null;
function ai(e, n, t, r) {
  if (((Dr = null), (e = Xi(r)), (e = kn(e)), e !== null))
  ...
  nl = V({}, Gt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== pt &&
            (pt && e.type === "mousemove"
              ? ((_l = e.screenX - pt.screenX), (Cl = e.screenY - pt.screenY))
              : (Cl = _l = 0),
            (pt = e)),
          _l);
    },
...
function ta(e) {
  ...
  function k(f, a, d, v) {
    ...
    if (j.done) return t(f, N), U && gn(f, P), E;
    if (N === null) {
...
function yo(e, n, t, r, l, i) {
  if (
    ...
    i = 0;
    do {
      if (((Nt = !1), (Ht = 0), 25 <= i)) throw Error(y(301));
      (i += 1),
        (Z = Y = null),
        (n.updateQueue = null),
        (xr.current = ld),
...
function nd(e, n, t) {
  ...
  if (xa(e)) _a(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = oe()), Re(t, e, r, l), Ca(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
  ...
  td = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qt(9, ca.bind(null, r, i, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Tu(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Cr(e, n), Na(n, t, r), Ei(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
    ...
    (o.state = p),
      ...
      u !== r || p !== s || fe.current || Je
        ? (typeof h == "function" && (Si(n, t, h, r), (s = n.memoizedState)),
    ...
    u !== m || p !== w || fe.current || Je
      ? (typeof g == "function" && (Si(n, t, g, r), (w = n.memoizedState)),
...
function Oa(e, n, t) {
  ...
  if (i) {
    ...
    return (
      ...
      u !== null ? (i = cn(u, i)) : ((i = _n(i, o, t, null)), (i.flags |= 2)),
      (i.return = n),
      (r.return = n),
      (r.sibling = i),
      (n.child = r),
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[vi], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Re(e, n, t, r) {
  if (50 < Tt) throw ((Tt = 0), (Mi = null), Error(y(185)));
  Xt(e, t, r),
    (!(R & 2) || e !== J) &&
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = tt(Error(y(423)), n)), (n = Lu(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = tt(Error(y(424)), n)), (n = Lu(e, n, r, t, l));
            break e;
          } else
            for (
...
ys = Co;
gs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, hs, vs, Co] },
  vt = {
...
const jd = ({
    ...
    _.jsxs("header", {
      className: "recipe_card__header",
      children: [
        _.jsxs("div", {
          className: "rating_component",
          children: [
            _.jsxs("div", {
              children: [
                _.jsx("img", {
            ...
            _.jsx("p", { children: "4.5 of 344 votes" }),
          ],
        }),
        _.jsx("div", {
          className: "recipe_card__preview",
          children: _.jsx("img", {
            src: `./images/${t}.jpeg`,
            alt: "recipe preview",
          }),
        ...
        _.jsxs("div", {
          className: "recipe_card__presentation",
          children: [
            _.jsx("h1", { children: e }),
            _.jsx("p", { children: n }),
            _.jsxs("ul", {
              className: "recipe_card__ul",
              children: [
                _.jsxs("li", {
                  children: [
                    _.jsx("h3", { children: "Servings" }),
                    _.jsxs("p", { children: [r, " people"] }),
                  ],
                }),
                _.jsxs("li", {
                  children: [
                    _.jsx("h3", { children: "Total price" }),
                    _.jsxs("p", { children: [l, "$EUR"] }),
                  ],
                }),
                _.jsxs("li", {
                  children: [
                    _.jsx("h3", { children: "price per person" }),
                    _.jsxs("p", { children: [Math.round(l / r), "$EUR"] }),
                  ],
                }),
              ],
            }),
  ...
  Rd = ({ timePrep: e }) =>
    _.jsxs("div", {
      className: "recipe_card__div",
      children: [
        _.jsx("h2", { children: "Preparation Time" }),
        _.jsxs("ul", {
          className: "recipe_card__ul recipe_card__ul-prep",
          children: [
            _.jsxs("li", {
              children: [
                _.jsx("h3", { children: "Total" }),
                _.jsxs("p", { children: ["Approx. ", e, " min"] }),
              ],
            }),
            _.jsxs("li", {
              children: [
                _.jsx("h3", { children: "Preparation" }),
                _.jsxs("p", { children: [Math.round(e / 2), " minutes"] }),
              ],
            }),
            _.jsxs("li", {
              children: [
                _.jsx("h3", { children: "Cooking" }),
                _.jsxs("p", { children: [Math.round(e / 2), " minutes"] }),
              ],
            }),
          ],
  ...
  Od = {
    ...
    preview: ["omelette-preview-1", "omelette-preview-2", "omelette-preview-3"],
    rating: "4.7 from 344 votes",
    servings: 4,
    priceEUR: 14,
    preparationTime: { total: 10, preparation: 5, cooking: 5 },
    ingredients: [
      "2-3 large eggs",
      " Salt, to taste",
      "Pepper, to taste",
    ...
    instructions: [
      "Instructions Beat the eggs: In a bowl, beat the eggs with a pinch of salt and pepper until they are well mixed. You can add a tablespoon of water or milk for a fluffier texture.",
...
function Dd() {
  ...
  return _.jsxs("div", {
    ...
    children: [
      ...
      _.jsx(Rd, { timePrep: e.preparationTime.cooking }),
      _.jsxs("div", {
        className: "recipe_card__div",
        children: [
          _.jsx("h2", { children: "Ingredients" }),
          _.jsx("ul", {
            children: e.ingredients.map((n) => _.jsx("li", { children: n }, n)),
          }),
        ],
      }),
      _.jsxs("div", {
        className: "recipe_card__div",
        children: [
          _.jsx("h2", { children: "Instructions" }),
          _.jsx("ol", {
            children: e.instructions.map((n) =>
              _.jsx("li", { children: n }, n)
            ),
          }),
        ],
      }),
      _.jsxs("div", {
        className: "recipe_card__div",
        children: [
          _.jsx("h2", { children: "Nutrition" }),
          _.jsx("p", {
            children:
              "The table bellow shows nutritional values per serving without the additional fillings.",
          }),
          _.jsx("table", {
            children: _.jsx("tbody", {
              children: Object.entries(e.nutrition).map(([n, t]) =>
                _.jsxs(
                  "tr",
                  {
                    children: [
...
function Id() {
  return _.jsx("div", {
    className: "page_wrap",
    children: _.jsx("main", { className: "main", children: _.jsx(Dd, {}) }),
  });
}
Wl.createRoot(document.getElementById("root")).render(
  _.jsx(gc.StrictMode, { children: _.jsx(Id, {}) })
);
