...
console.log("cositas");
const d = document.getElementById("links_list"),
  s = document.getElementById("card"),
  g = [
    {
      id: "home",
      title: "Home",
...
d.addEventListener("mouseover", (a) => {
  ...
  if (!i) return;
  const n = i.dataset.link,
    o = g.find((e) => e.id === n);
  if (o) {
    const { id: e, title: t, img: r, desc: u, link: m } = o;
    (s.innerHTML = f(t, u, m, r)),
      s.setAttribute("aria-hidden", "false"),
      s.setAttribute("data-link", e),
      clearTimeout(c);
  }
});
function l() {
...
d.addEventListener("mouseenter", () => clearTimeout(c));
s.addEventListener("mouseenter", () => clearTimeout(c));
const f = (a, i, n, o) => `
    <div class="image">
    <img
      loading="lazy"
